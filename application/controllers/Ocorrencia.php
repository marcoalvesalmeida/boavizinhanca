...
class Ocorrencia extends CI_Controller {
    ...
    public function salvar(){
        ...
        $dados['data_ocorrencia'] = $this->input->post('data');
        $dados['descricao'] = $this->input->post('descricao');
        $dados['tipo_crime'] = $this->input->post('tipo');
        $dados['titulo'] = $this->input->post('tipo');
    ...
    public function salvar1() {
        ...
        if ($this->input->post('rua') == NULL) {
            ...
            $dados['data_ocorrencia'] = $this->input->post('data_ocorrencia');
            $dados['rua'] = $this->input->post('rua');
            $dados['descricao'] = $this->input->post('descricao');
